...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppWeb = __webpack_require__(1);
	...
	var _vueProgressbar = __webpack_require__(55);
	...
	// 全局注册组件
	Vue.component('osc-root', __webpack_require__(60)); /**
	                                                            * @author walid
	                                                            * @date 2016/03/20
	                                                            * @description 程序入口启动配置
	                                                            */

	Vue.component('osc-navpage', __webpack_require__(64));
	Vue.component('osc-navbar', __webpack_require__(68));
	Vue.component('osc-tabbar', __webpack_require__(72));
	Vue.component('osc-list', __webpack_require__(80));
	Vue.component('osc-scroller', __webpack_require__(84));
	...
	Vue.use(_vueProgressbar2.default, {
	  thickness: '5px',
	  color: '#00bf11',
	  autoRevert: true,
	  location: 'top',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = [{
	  path: '/',
	  redirect: {
	    path: _route2.default.mine.path
	  }
	}, {
	  title: _route2.default.home.title,
	  path: _route2.default.home.path,
	  component: _route2.default.home.component
	}, {
	  title: _route2.default.launch.title,
	  path: _route2.default.launch.path,
	  component: _route2.default.launch.component
	}, {
	  title: _route2.default.userInfo.title,
	  path: _route2.default.userInfo.path,
	  component: _route2.default.userInfo.component
	}, {
	  title: _route2.default.personal.title,
	  path: _route2.default.personal.path,
	  component: _route2.default.personal.component
	}, {
	  title: _route2.default.list.title,
	  path: _route2.default.list.path,
	  component: _route2.default.list.component
	}, {
	  title: _route2.default.scroller.title,
	  path: _route2.default.scroller.path,
	  component: _route2.default.scroller.component
	}, {
	  title: _route2.default.web.title,
	  path: _route2.default.web.path,
	  component: _route2.default.web.component
	}, {
	  title: _route2.default.mine.title,
	  path: _route2.default.mine.path,
	  component: _route2.default.mine.component
	}, {
	  title: '404',
	  path: '*',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navigator = __webpack_require__(19);
	...
	var _imgurl = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _instance = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _vueProgressbar=__webpack_require__(56),_vueProgressbar2=_interopRequireDefault(_vueProgressbar);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function assign(a){// eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  components: {
	    tabitem: __webpack_require__(75)
	  },
	  created: function created() {
