...
<html lang="en">
<head>
    <title>Code coverage report for src/custom-nodes/string-array-nodes/StringArrayNode.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/custom-nodes/string-array-nodes</a> StringArrayNode.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="branch-1 cbranch-no" title="branch not covered" >        return super.getNode();</span>
    }
&nbsp;
    /**
     * @returns {TStatement[]}
