...
<html lang="en">
<head>
    <title>Code coverage report for src/custom-nodes/debug-protection-nodes/group/DebugProtectionCustomNodeGroup.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/custom-nodes/debug-protection-nodes/group</a> DebugProtectionCustomNodeGroup.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6251x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { injectable, inject } from 'inversify';
...
&nbsp;
        ...
        this.appendCustomNodeIfExist(CustomNodes.DebugProtectionFunctionIntervalNode, <span class="fstat-no" title="function not covered" >(</span>customNode: ICustomNode) =&gt; {
            const programBodyLength: number = <span class="cstat-no" title="statement not covered" >blockScopeNode.body.l</span>ength;
            const randomIndex: number = <span class="cstat-no" title="statement not covered" >RandomGeneratorUtils.getRandomInteger(0, p</span>rogramBodyLength);
&nbsp;
<span class="cstat-no" title="statement not covered" >            NodeAppender.insertNodeAtIndex(blockScopeNode, customNode.getNode(), r</span>andomIndex);
        });
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.debugProtectionInterval) {
<span class="cstat-no" title="statement not covered" >            this.customNodes.set(CustomNodes.DebugProtectionFunctionIntervalNode, d</span>ebugProtectionFunctionIntervalNode);
        }
    }
}
&nbsp;</pre></td></tr>
