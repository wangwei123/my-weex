...
<html lang="en">
<head>
    <title>Code coverage report for src/custom-nodes/self-defending-nodes/group/SelfDefendingCustomNodeGroup.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/custom-nodes/self-defending-nodes/group</a> SelfDefendingCustomNodeGroup.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (stackTraceData.length) {
<span class="cstat-no" title="statement not covered" >                targetBlockScope = NodeAppender.getOptimalBlockScope(stackTraceData, randomStackTraceIndex, 1</span>);
            } else {
