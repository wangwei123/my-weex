...
<html lang="en">
<head>
    <title>Code coverage report for src/node-transformers/control-flow-transformers/control-flow-replacers/AbstractControlFlowReplacer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/node-transformers/control-flow-transformers/control-flow-replacers</a> AbstractControlFlowReplacer.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8648x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8648x</span>
<span class="cline-any cline-yes">3073x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (controlFlowStorage.getStorage().has(storageKey)) {
<span class="cstat-no" title="statement not covered" >                return generateStorageKey(l</span>ength);
            }
&nbsp;
            return storageKey;
        };
