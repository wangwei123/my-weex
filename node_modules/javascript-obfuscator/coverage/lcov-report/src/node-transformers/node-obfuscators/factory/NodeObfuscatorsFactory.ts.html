...
<html lang="en">
<head>
    <title>Code coverage report for src/node-transformers/node-obfuscators/factory/NodeObfuscatorsFactory.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">src/node-transformers/node-obfuscators/factory</a> NodeObfuscatorsFactory.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >export class NodeObfuscatorsFactory extends <span class="cstat-no" title="statement not covered" >AbstractNodeTransformersFactory {</span></span>
    /**
